...
INVESTIGATION_STEP_DEFS: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "identify_source",
        "title": "Identify who accessed the device",
        "summary": "Resolve the source of the allowed sessions to a workstation and account, and check it against approved maintenance windows.",
        "follow_up_id": None,
        "bundle_with": "check_firewall_activity",
        "tools": ["Splunk MCP", "CMDB"],
        "default_selected": True,
        "phase": "investigation",
    },
    {
...
REMEDIATION_STEP_DEFS: tuple[dict[str, Any], ...] = (
    {
        ...
        "summary": "Ask OT engineering whether any authorized maintenance by ot_vendor_svc explains the access.",
    ...
    },
    {
        ...
        "summary": "Record the OT team's reply as evidence before any containment decision.",
    ...
    },
    {
        ...
        "summary": "Open an OT security incident: live device, unauthorized access, stale asset record.",
    ...
    {
        "id": "restrict_ot_path",
        "title": "Narrow the firewall path to 10.80.4.14",
        "summary": "Restrict the east-west allow to the approved engineering workstation only, in an OT-safe change window.",
        "follow_up_id": None,
        "bundle_with": "create_incident_ticket",
        "tools": ["SOAR / firewall"],
        "hil_required": True,
        "default_selected": True,
        "phase": "remediation",
    ...
    {
        "id": "rtu_integrity",
        "title": "Check RTU configuration against its baseline",
        "summary": "Compare OT-RTU-14 logic and setpoints with the last approved baseline.",
        "follow_up_id": None,
        "bundle_with": "create_incident_ticket",
        "tools": ["OT inventory"],
        "default_selected": True,
