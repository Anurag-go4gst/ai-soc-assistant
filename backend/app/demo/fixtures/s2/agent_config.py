...
REMEDIATION_STEP_DEFS: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "block_session",
        "title": "Block the offending session at the AI gateway",
        "summary": "Terminate session sess-ai-8841 and rate-limit user guest-web-5521 for 24 hours.",
        "follow_up_id": None,
        "bundle_with": "create_ai_incident_ticket",
        "tools": ["AI gateway"],
        "hil_required": True,
        "default_selected": True,
        "phase": "remediation",
    },
    {
        ...
        "title": "Rotate and scope down the export connector credential",
        "summary": "Issue a new ai-assistant-export-connector credential limited to approved export jobs; revoke the old one.",
    ...
    },
    {
        ...
        "summary": "Email the AppSec / AI platform team the evidence package and the hardening ask.",
    ...
    },
    {
        ...
        "summary": "Confirm the old export connector credential is revoked and the new one is scoped.",
    ...
    {
        "id": "extend_detection",
        "title": "Request a detection update",
        "summary": "Raise a detection-engineering change to add the two observed prompt patterns and the denied-tool signal to EC_AI_Prompt_Injection_Detection.",
        "follow_up_id": None,
        "bundle_with": "update_incident",
        "tools": ["ITSM"],
        "default_selected": True,
        "phase": "remediation",
    },
