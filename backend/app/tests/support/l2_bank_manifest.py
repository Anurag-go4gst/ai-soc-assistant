...
_RESERVED_CASES: tuple[L2Case, ...] = (
    ...
    L2Case(
        ...
        current_status="PENDING_CONTRACT_P1",
    ...
    L2Case(
        ...
        current_status="PENDING_CONTRACT_P1",
        why_this_case_exists="P1 reproduces and resolves the conflicting fallback labels.",
        findings=("H-TRACE-02",),
    ),
    L2Case(
        case_id="L2.R.P1.03",
    ...
    L2Case(
        ...
        current_status="PENDING_CONTRACT_P2",
        why_this_case_exists=(
            "P0.11 proves the gate fires; this row is about what the analyst then sees. "
            "Distinct invariant: mechanism versus legibility."
        ),
        findings=("H-SPL-01",),
    ),
    L2Case(
    ...
    L2Case(
        ...
        current_status="PENDING_CONTRACT_P4",
        why_this_case_exists="P4 defines the provenance schema; P8 depends on it for A/B.",
