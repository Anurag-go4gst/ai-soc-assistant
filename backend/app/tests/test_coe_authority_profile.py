...
_AUTHORITY = {
    ...
    "AI_SOC_INVESTIGATION_PLANNER_ENABLED": "true",
    "AI_SOC_PLAN_DELTA_ENABLED": "true",
    "AI_SOC_INVESTIGATION_OUTCOME_V2_ENABLED": "true",
    "AI_SOC_REMEDIATION_PLANNER_ENABLED": "true",
    "AI_SOC_ACTION_EMAIL_ENABLED": "true",
    "AI_SOC_GUIDED_HYBRID_INVESTIGATION_ENABLED": "true",
    "AI_SOC_RUNTIME_ENRICHMENT_ENABLED": "true",
