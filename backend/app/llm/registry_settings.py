...
ROLE_DEFAULTS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "output": "InvestigationPlanProposal JSON",
        "authority": "advisory",
        "validator_required": True,
        "strict_json": True,
        "temperature": 0.0,
    ...
    {
        "role": "evidence_reasoner",
        "preferred_provider": REASONING_PROVIDER_ID,
        "preferred_model": REASONING_DEFAULT_MODEL,
        "mode": "advisory_reasoning",
        "output": "evidence_gap_interpretation JSON",
        "authority": "advisory",
        "validator_required": True,
        "strict_json": True,
        "temperature": 0.0,
    ...
    {
        "role": "hypothesis_reasoner",
        "preferred_provider": REASONING_PROVIDER_ID,
        "preferred_model": REASONING_DEFAULT_MODEL,
        "mode": "advisory_reasoning",
        "output": "bounded_hypotheses JSON",
        "authority": "advisory",
        "validator_required": True,
        "strict_json": True,
        "temperature": 0.0,
...
ROLE_ENV_MAP: dict[str, tuple[str, str]] = {
    ...
    "investigation_planner": (
        "ai_soc_llm_reasoning_provider",
        "ai_soc_llm_reasoning_model",
    ),
    ...
    "evidence_reasoner": ("ai_soc_llm_reasoning_provider", "ai_soc_llm_reasoning_model"),
    "hypothesis_reasoner": ("ai_soc_llm_reasoning_provider", "ai_soc_llm_reasoning_model"),
    "plan_delta_reasoner": ("ai_soc_llm_reasoning_provider", "ai_soc_llm_reasoning_model"),
    ...
    return [
        ...
        },
        {
            ...
            "checks": {
                ...
                "evidence_reasoner": "suitable_with_guard",
                "hypothesis_reasoner": "suitable_with_guard",
                "plan_delta_reasoner": "suitable_with_guard",
                "risk_rationale_reasoner": "suitable_with_guard",
                "investigation_planner": "suitable_with_guard",
