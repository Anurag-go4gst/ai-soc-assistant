...
_CONCEPT_MARKERS: tuple[tuple[tuple[str, ...], str], ...] = (
    ...
    (("scheduled task", "persistence", "autorun", "service creation"), "scheduled-task and persistence details"),
    ...
    (("firewall", "network connection", "network flow", "network session", "connection record", "network"), "network connection records"),
