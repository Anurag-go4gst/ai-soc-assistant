...
| `plans/2026-08-15_0602_canonical-architecture-authority-convergence.md` | **Done (34/34) — Plan 8, PR pending user merge.** Frozen `architecture.md` is read-only. Converge final RQC, ResourcePlan authority, EvidenceState, InvestigationOutcome, exact-call SPL authorization, trust boundaries, and T4 reliability. Production GO remains deferred. F3 T4 serving and live MCP stay unproven. PlanDelta / step-instance execution remain `NOT_REQUIRED_FOR_CURRENT_SCOPE`. |
