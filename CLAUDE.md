...
| Plan | Status |
|------|--------|
| `plans/2026-08-10_1103_architecture-resource-plan-execution-and-adaptive-planning.md` | **In Progress** — P0/A0/A1 done; B1 = `RETIRE` (planning-model rails retired, live pre-SPL discovery kept); C0 = `EXECUTION-DRIVEN` behind `AI_SOC_RESOURCE_PLAN_EXECUTION_ENABLED` (default false, flag-off byte-identical); C1-E1…E6 done with governance PASS, backend `4978 passed`, parity `120 exact`, probes 10/10 + 11/11. Remaining: G1 closure |
