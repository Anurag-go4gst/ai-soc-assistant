...
| Plan | Status |
|------|--------|
| [`2026-07-23_1315_resource-planner-north-star-cutover.md`](2026-07-23_1315_resource-planner-north-star-cutover.md) | **In progress** (`feat/resource-planner-north-star`) — items 2–10 done: live catalogue bind, specialist merge, parallel `Send`, worker bundle sync, deterministic knowledge specialist, and COE-approved RP default cutover proposal; items 11–12 (default flip, imperative retirement) pending |
