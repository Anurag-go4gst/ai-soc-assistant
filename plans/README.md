...
| Plan | Status |
|------|--------|
| [`2026-07-23_1315_resource-planner-north-star-cutover.md`](2026-07-23_1315_resource-planner-north-star-cutover.md) | **In progress** (`feat/resource-planner-north-star`) — items 2–11 done: live catalogue bind, specialist merge, parallel `Send`, worker bundle sync, deterministic knowledge specialist, COE-approved cutover proposal, and RP graph default (`langgraph_orchestration_enabled=true`); item **12** imperative retirement (12a–12d) pending |
