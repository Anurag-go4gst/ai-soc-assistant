...
| Plan | Status |
|------|--------|
| [`2026-07-23_1315_resource-planner-north-star-cutover.md`](2026-07-23_1315_resource-planner-north-star-cutover.md) | **Draft** — follow-on for residual RP north-star gaps: live catalogue router wiring, merged specialist proposals, parallel fan-out, optional LLM-primary specialist planning, RP default cutover, and eventual imperative/linear runner retirement |
