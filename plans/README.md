...
| Plan | Status |
|------|--------|
| [`2026-08-16_2310_races-experience-center.md`](2026-08-16_2310_races-experience-center.md) | **Done (34/34) — merged PR [#143](https://github.com/Anurag-go4gst/ai-soc-assistant/pull/143) @ `d4f9210`.** Isolated Experience Center flagships + Lab. Follow-on UX: `feat/races-investigation-execution-ux`. Do not touch live `/chat` in that follow-on unless explicitly scoped. |
