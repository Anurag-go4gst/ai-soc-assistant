...
| Plan | Status |
|------|--------|
| [`2026-07-24_2310_guided-detail-tools-consumable-handoff.md`](2026-07-24_2310_guided-detail-tools-consumable-handoff.md) | **In Progress (rev 13) — CANONICAL ACTIVE PLAN; reference this one only.** Gate 1 complete (items 12/13/14): sentinel 17/17, clean-answer 120/120, typed `CanonicalPlanningOutcome`, no partial `EvidencePlan` on clarification. Items 30 + 31 done. Production parity baseline `120 / 113 exact / 0 approved / 7 critical_mismatch` (`imperative_canonical` vs `resource_planner_graph`), superseding the legacy shadow-graph measurement. Next: item 32 shared `run_canonical_planning` seam. Loop runner: [`LOOP_RUNNER_guided-detail-tools-consumable-handoff.md`](LOOP_RUNNER_guided-detail-tools-consumable-handoff.md) |
