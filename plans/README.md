...
| Plan | Status |
|------|--------|
| [`2026-08-16_2310_races-experience-center.md`](2026-08-16_2310_races-experience-center.md) | **Active — RACES / Experience Center (rev 7).** Checklist 34/34 including G5. Draft PR [#143](https://github.com/Anurag-go4gst/ai-soc-assistant/pull/143) (`feat/races-experience-center` → `master`). Awaiting user merge decision. Do not touch live `/chat`. |
