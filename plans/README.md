...
| Plan | Status |
|------|--------|
| [`2026-08-15_0602_canonical-architecture-authority-convergence.md`](2026-08-15_0602_canonical-architecture-authority-convergence.md) | **Active — Plan 8.** Frozen [`architecture.md`](../architecture.md) is read-only. Final RQC, ResourcePlan authority, EvidenceState, InvestigationOutcome, exact-call authorization, trust boundaries, T4 reliability. Production GO deferred. F3 and live MCP unproven. |
