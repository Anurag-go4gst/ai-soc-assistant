...
| Plan | Status |
|------|--------|
| [`2026-08-16_2310_races-experience-center.md`](2026-08-16_2310_races-experience-center.md) | **Active — RACES / Experience Center (rev 3 loop plan).** Evolve isolated EC showcase. Do not touch live `/chat`. Runner: [`LOOP_RUNNER_races-experience-center.md`](LOOP_RUNNER_races-experience-center.md). Start: `loop-asap — execute plans/2026-08-16_2310_races-experience-center.md`. First item **L0**. |
