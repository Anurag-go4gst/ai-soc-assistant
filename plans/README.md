...
| Plan | Status |
|------|--------|
| [`2026-07-24_2310_guided-detail-tools-consumable-handoff.md`](2026-07-24_2310_guided-detail-tools-consumable-handoff.md) | **In Progress (rev 8)** — Phase 1 done; Phase 2 execution order fixed; clarification without EvidencePlan; mandatory CI Postgres; **not implemented** |
