...
| [`2026-07-28_1630_per-step-dispatch-idempotency-and-uncertain-execution-safety.md`](2026-07-28_1630_per-step-dispatch-idempotency-and-uncertain-execution-safety.md) | **Next engineering priority (D)** — Hook side-effect audit first; typed replay payloads; leases; `REQUIRES_RECONCILIATION`. After A+B. |
