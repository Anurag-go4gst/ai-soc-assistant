...
| Plan | Status |
|------|--------|
| [`2026-08-13_1440_production-activation-t4-serving-and-governance-readiness.md`](2026-08-13_1440_production-activation-t4-serving-and-governance-readiness.md) | **Draft (Plan 6) — 37 items.** Test arms → approved production flag profile → persistent VPS config → restart/reliability/rollback → `P6_PRODUCTION_GO_LIVE`. Repo defaults may stay false while VPS profile is persistently ON. Branch `1d32ac6`. Loop runner: [`LOOP_RUNNER_production-activation-t4-serving-and-governance-readiness.md`](LOOP_RUNNER_production-activation-t4-serving-and-governance-readiness.md). Do not execute until approved. Plan 5 remains the closed architecture baseline (`3d22260`). |
