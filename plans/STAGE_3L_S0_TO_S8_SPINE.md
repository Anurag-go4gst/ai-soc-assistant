...
| S7 | `hard_preconditions` runtime enforcement | [docs/stage3l_s7_hard_preconditions_design.md](../docs/stage3l_s7_hard_preconditions_design.md) | Design done — **S7.1** pure evaluator; S7.2–S7.4 proposed | — |
| S7.1 | Pure precondition evaluator | `precondition_evaluator.py` | Done — not wired to `/chat` | — |
| S7.2 | Registry-backed checks | — | Proposed | — |
