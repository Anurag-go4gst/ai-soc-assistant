...
- 2026-08-13 — **MERGED — PR #131, merge commit `3d222600dc55a47c229b604a4a21800f35b313a3`, `--merge` not squash (16 Plan 5 commits preserved).** This is the **new authoritative baseline**, superseding `2f678b9`. Pre-merge cumulative review over `2f678b9..3c25437`: 68 files, `+15958/-126`; goldens, governed registries and frozen routing baseline **UNCHANGED**; runtime-map content unchanged (A5 only added it to `PROTECTED`); execution/T4/enforcement flags still `false`; no capability widening; no unrelated user-owned dirt in the range; the six stale governance reports correctly excluded.
