...
- [ ] **P0 — Freeze and freshly verify the post-G1 baseline**
  ...
  - **Evidence:** _(pending — P0 must be re-run from scratch against the `f34f4d8` baseline; the superseded attempt below is retained as the record of why the baseline moved)_
