...
PACKS = {
    ...
    "q0.q010": {
        ...
        "use_case_id": "auth_failed_login_spike",
        "review_status": "reviewed",
        "provenance": "batch_d_weak_exact_spl_row",
        "answer_shape": "weak_exact_spl_review",
        "required_evidence": ["failed_login_count", "user", "threshold", "time_window"],
        "optional_evidence": ["src_ip", "host"],
        "source_needs": ["authentication_logs"],
        "dependency_gaps": ["row_authority_not_ready", "threshold_baseline_plus_source"],
        "mitre_candidates": ["T1110.001"],
        "must_not_claim": [
            "confirmed_brute_force_without_threshold_policy",
            "password_spray_without_multi_user_context",
        ],
        "caveats": [_COMMON_CAVEAT],
        "spl_family_suggestion": "auth_failed_login_spike",
        "spl_template_id": "auth_failed_login_spike",
